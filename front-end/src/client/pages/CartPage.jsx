...
const CartPage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${REST_API_BASE_URL}/carts/my-cart`, {
        headers: {
  ...
  const deleteCartItem = (cartItemId) => {
    axios
      .delete(`${REST_API_BASE_URL}/carts/remove-item/${cartItemId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const increaseQuantity = (cartItemId) => {
    axios
      .put(
        `${REST_API_BASE_URL}/carts/increase-quantity/${cartItemId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const decreaseQuantity = (cartItemId) => {
    axios
      .put(
        `${REST_API_BASE_URL}/carts/decrease-quantity/${cartItemId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      .catch((error) => {
        console.error(
          "There was an error decreasing the item quantity:",
          error
        );
      });
  };
  ...
  const handleCheckout = () => {
    ...
    axios
      .post(`${REST_API_BASE_URL}/orders`, orderData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  return (
    <section
      className="main-cart-page main-container col1-layout mobile-tab active"
      id="cart-tab"
      data-title="Giỏ hàng"
    >
      <div className="wrap_background_aside padding-top-15 margin-bottom-40 padding-left-0 padding-right-0 cartmbstyle">
                    ...
                    <div key={index} className="item-product">
                      ...
                      <div className="item-product-cart-mobile">
                        <a
                          ...
                          className="product-images1  pos-relative embed-responsive embed-responsive-1by1"
                        ...
                        <div className="title-product-cart-mobile">
                          <h3 className="product-name">
                            ...
                            <a
                              onClick={() => getProduct(item.productEntity.id)}
                              className="text2line"
                              title="Bánh blue sky cupcakes"
                            >
                              {item.productEntity.nameProduct}
                            </a>
                          </h3>
                ...
                <div className="header-cart-price">
                  <div className="timedeli-modal">
                    <div className="timedeli-modal-content">
                      <button
                        type="button"
                        className="close window-close d-sm-none"
                        aria-label="Close"
                      >
                      ...
                      <div className="timedeli d-sm-block">
                        <div className="ega-delivery__wrapper left">
                          <p className="ega-delivery__title">
                            HẸN GIỜ NHẬN HÀNG
                          </p>
                      ...
                      <div className="timedeli-cta">
                        <button
                          className="btn btn-block timedeli-btn  d-sm-none"
                          type="button"
                        >
                          <span>Xong</span>
                        </button>
                  ...
                  <div className="title-cart d-none d-sm-flex ">
                    ...
                    <i className="text-xs-right price_vat ">
                  ...
                  <div className="checkout d-none d-sm-block">
                    <button
                      className="btn btn-block btn-proceed-checkout-mobile"
                  ...
                  <div className="cart-trustbadge mt-3">
                    <span className="title-menu">Phương thức thanh toán</span>
                  ...
                  {isFormComplete ? (
                    ...
                    <div className="text-danger">
                      Vui lòng điền vào tất cả các trường bắt buộc để kích hoạt
                      thanh toán PayPal.
                    </div>
                  )}
                </div>
        ...
        <div
          className="cart-empty container card border-0 py-2 "
          style={{ display: "none" }}
        >
          <div className="alert green-alert section" role="alert">
            <div className="title-cart text-center">
              ...
              <h3>Hổng có gì trong giỏ hết</h3>
              <p> Về trang cửa hàng để chọn mua sản phẩm bạn nhé!!</p>
              <a title="Mua sắm ngay" className="btn btn-main">
                Mua sắm ngay
              </a>
            </div>
          </div>
